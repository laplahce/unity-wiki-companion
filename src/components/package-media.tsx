      ...
      {videoFile ? (
        ...
        <div className="pointer-events-none absolute inset-0 overflow-hidden">
          <iframe
            ...
            src={`https://www.youtube-nocookie.com/embed/${trailerId}?autoplay=1&mute=1&loop=1&playlist=${trailerId}&controls=0&modestbranding=1&playsinline=1&rel=0&showinfo=0&disablekb=1`}
